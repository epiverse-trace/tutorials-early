...
# extraire les données des trois premiers mois à partir de l'objet
...
# utiliser la fonction incidence() de la librairie {incidence2} pour générer
# les données d'incidence
...
# Adapter une courbe aux données d'incidence. Le modèle choisi est une
# distribution binomiale négative avec un seuil de significativité (alpha)
# de 0.05
fitted_curve_nb <-
  df_incid %>%
  nest(.key = "data") %>%
