...
Tutorials on reading and cleaning case data, and make line list for outbreak analytics with R developed by the Epiverse-TRACE initiative. These tutorials are visible at: <https://epiverse-trace.github.io/tutorials-early/>. 
...
- [Abdoelnaser Degoot](https://github.com/Degoot-AM/)
...
```
Degoot A, Valle-Campos A (2025). "Epiverse-TRACE Tutorials Early: Read and
clean case data, and make linelist for outbreak analytics with R."
