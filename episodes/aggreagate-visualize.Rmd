...
ggplot2::ggplot(data = daily_incidence) +
  ...
  theme(
    ...
    plot.caption = element_text(face = "italic", hjust = 0), # italicized caption
...
ggplot2::ggplot(data = daily_incidence_2) +
  ...
  theme(
    ...
    axis.text.x = element_text(angle = 45, vjust = 0.5) # rotate x-axis text for readability
  ) +
  labs(
    x = "Date", # x-axis label
    y = "Number of cases", # y-axis label
  ...
  scale_fill_manual(values = c("lightblue", "lightpink")) # custom fill colors for sex
```
