...
You can use numeric values or text string such `day`, `daily`, `week(s)`, `weekly`, `months(s)`, `monthly` as to setup the aggregating interval:
...
The following code snippets generate epi-curves for the `daily_incidence` and `weekly_group_incidence` incidence objects mentioned above.
