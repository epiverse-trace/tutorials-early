...
Let's change some variable data types to identify how `linelist::validate_linelist()` will react when your input data has a variable with a different data type.
...
Other frequent changes can be having a date variable like `date_onset` changed to a character, or a factor variable like `gender` changed to an integer.
