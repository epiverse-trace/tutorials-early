...
Have you noticed that `{cleanepi}` contains a set of functions to **diagnose** the cleaning status and another set to **perform** a cleaning action?

To identify both groups:

- On a piece of paper, write the names of each function under the corresponding column:

| **Diagnose** cleaning status | **Performs** cleaning action |
|---|---|
| ... | ... |
