...
Note that the `{cleanepi}` package does not remove inconsistent observations found, it is only diagnose and report their indices.
To remove them, we can do the following code. 
