...
Now, try these additional changes to variables:
...
Have you ever experienced an unexpected change of variable type when running a lengthy analysis during an emergency response? 

What actions did you take to overcome this inconvenience?

Imagine you automated your analysis to read your date directly from source, but they remove a variable you where using. What step would be sensible to this action? 
