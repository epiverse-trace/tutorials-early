...
```{r}
# remplacer automatiquement les valeurs mals orthographiées
# de la colonne 'status' avec les vraies
...
# remplacer les valeurs mals orthographiées de la colonne 'status'
# avec les vraies apres avoir demander la confirmation à l'utilisateur
sim_ebola_data <- cleanepi::correct_misspelled_values(
  data = sim_ebola_data,
  target_columns = "status",
  wordlist = c("confirmed", "probable", "suspected", "died", "recovered"),
