...
In the solution we added `date_first_pcr_positive_test` as part of the Date columns to be standardized given that it often used in disease outbreak analysis.
...
Furthermore, you can combine multiple data cleaning tasks via the base R pipe (`|>`) or the `{magrittr}` pipe (`%>%`) operator, as shown in the below code 
snippet. 
