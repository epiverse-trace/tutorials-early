...
**Epidemic theory** : Epidemiological parameters, Disease time periods, such as Incubation period, Generation time, Serial interval.

:::::::::::::::::::::::::::::::::

## Introduction

The [natural history](../learners/reference.md#naturalhistory) of an infectious disease shows that its development has a regularity from stage to another, which roughly goes through: presymptomatic period, symptomatic period and recovery period. The time periods from an infectious disease inform about the timing of transmission and interventions.
...
generation_time <- 
  EpiNow2::dist_spec(
    ...
    sd = covid_serialint$summary_stats$, # replaced!
    max = 20,
    distribution = "gamma"
  )
```
