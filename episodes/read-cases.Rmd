...
# read data
case_data <- rio::import(file.path("data", "ebola_cases.csv"))
# preview data
head(case_data, 5)
```
...
```
Click [here](https://epiverse-trace.github.io/tutorials-early/data/Marburg.zip) to download a zip file containing data for Marburg outbreak  and then import it to your working environment.
::::::::::::::::::::::::::
...
The following code chunk demonstrates how to create a temporary SQLite database in memory, store the `case_data` as a table on it, and subsequently read it:
