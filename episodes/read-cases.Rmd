...
The first step in outbreak analysis is importing the your dataset into the `R` environment. Data can come from local sources (like files on your computer) or external sources (databases and health information systems (HIS)). 
