...
```{r, message=FALSE, warning=FALSE}
base::plot(covid19_eng_incidence_data) + labs(x = "Date", y = " Cases")+theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1))
```
...
base::plot(weekly_covid19_eng_incidence, )+labs(x= "Date", y ="Cases")+ theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
```
