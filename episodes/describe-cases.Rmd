...
simulated `linelist` data based on the  date of onset.
...
## Challenge 1: Can you do it?
 ...
 death to generate simulated linelist data for a Marburg outbreak that has probability of $0.5$ infection?
 - Aggregate the generated linelist and produce some a few epidemic curves?
...
- Use `{simulist}` to generate synthetic outbreak data
- Use `{incidence2}` to aggregate and visualize case data based on a date event.  
::::::::::::::::::::::::::::::::::::::::::::::::
