...
**Then,** after you get your estimated values you can create manually your own` <epidist>` class objects with `epiparameter::epidist()`. Take a look to its [reference guide on "Create an `<epidist>` object"](https://epiverse-trace.github.io/epiparameter/reference/epidist.html#ref-examples)!
