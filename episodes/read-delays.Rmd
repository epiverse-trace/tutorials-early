...
ebola_serial_discrete_max <- ebola_serial_discrete$prob_dist$q(p = 0.999)

ebola_serial_quantiles <- seq(1L, to = ebola_serial_discrete_max, by = 1L)

serial_interval_ebola <-
  dist_spec(
    pmf = ebola_serial_quantiles
  )
...
# adapt epiparameter to epinow2
covid_incubation_parameters <- get_parameters(covid_incubation)
...
ebola_incubation_discrete_max <- ebola_incubation_discrete$prob_dist$q(p = 0.999)

ebola_incubation_quantiles <- seq(1L, to = ebola_incubation_discrete_max, by = 1L)

incubation_period_ebola <-
  dist_spec(
    pmf = ebola_incubation_quantiles
  )
