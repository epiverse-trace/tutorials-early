...
The [`{incidence2}`](https://www.reconverse.org/incidence2) package offers a useful function called `incidence2::incidence()` for grouping case data, usually based around dated events and/or other characteristics.
...
With the `{incidence2}` package, you can specify the desired interval (e.g. day, week) and categorize cases by one or more factors.
...
We invite you to take a look at the `{incidence2}` [package vignette](https://www.reconverse.org/incidence2/vignette.html).
